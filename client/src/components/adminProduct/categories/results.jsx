...
import { deleteCategory } from '../../../redux/actions/delete_category'
...
export default function EnhancedTable({displayProductForm, rows, setSearchQuery}) {
  ...
  const handleDelete = () =>{
    dispacth(deleteCategory(selected[0]))
    setSelected([])
    setSearchQuery("")
    setTimeout(()=>{dispacth(getCategories())},2000)
  }
